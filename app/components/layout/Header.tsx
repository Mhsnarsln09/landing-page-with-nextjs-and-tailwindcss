const Header = () => {
    return (
        <div className="w-full">
            <div className='w-full bg-primary h-10 hidden xl:block'>
                <div className='max-w-7xl mx-auto h-full flex items-center justify-between pl-3 pr-[34px]'>
                    <div className='flex items-center gap-x-2'>
                        ...
                        <p className='text-white text-sm font-normal'>Lorem Ipsum has been the industry's standard dummy </p>
                    </div>
                    <div className='flex items-center gap-x-10'>
                        <div className='flex items-center gap-x-2'>
                            ...
                            <p className='text-white text-sm font-normal'>+90123 45 67</p>
                        </div>
                        <div className='flex items-center gap-x-2'>
                            ...
                            <p className='text-white text-sm font-normal'>mail@mail.com</p>
                        </div>
                    </div>
                </div>
            </div>
